            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="addTeacher.action" class="form-horizontal" method="post" enctype="multipart/form-data">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="email" class="span3 m-wrap" id="teaEmail" name="teaEmail" required />
                                </div>
                            </div>
                            <div class="control-group">
