            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="teachereditInfoDetail.action" class="form-horizontal" method="post" enctype="multipart/form-data">
                            <div class="control-group">
                                <label class="control-label">教师编号</label>
                                <div class="controls">
                                    <input class="span3 m-wrap" id="teaId" name="teaId" type="text" value="${sessionScope.teacher.teaId}" readonly/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">教师名称</label>
                                <div class="controls">
                                    <input type="text" class="span3 m-wrap" id="teaName" name="teaName" value="${sessionScope.teacher.teaName}" />
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">电子邮箱</label>
                                <div class="controls">
                                    <input type="email" class="span3 m-wrap" id="teaEmail" name="teaEmail" value="${sessionScope.teacher.teaEmail}" />
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">密码</label>
                                <div class="controls">
                                    <input type="password" class="span3 m-wrap" id="teaPwd" name="teaPwd" value="${sessionScope.teacher.teaPwd}" />
                                </div>
                            </div>
