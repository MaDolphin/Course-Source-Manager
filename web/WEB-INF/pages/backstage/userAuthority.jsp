                ...
                <div class="span12">
                    ...
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover" id="sample_user">
                            ...
                            <tbody>
                            <c:forEach items="${sessionScope.userListByAuthority}" var="user">
                                <tr class="odd gradeX">
                                    ...
                                    <td class="hidden-480">
                                        <a href="javascript:if(confirm('确认审核通过该用户吗?'))window.location='passUser.action?userId=${user.userId}'" class="btn mini purple"><i class="icon-edit"></i> 通过</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
