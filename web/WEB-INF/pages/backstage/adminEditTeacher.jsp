            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="editTeacher.action" class="form-horizontal" method="post" enctype="multipart/form-data">
                            <div class="control-group">
                                <label class="control-label">教师编号</label>
                                <div class="controls">
                                    <input type="text" class="span3 m-wrap" id="teaId" name="teaId" value="${sessionScope.edit_teacher.teaId}" readonly/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">教师姓名</label>
                                <div class="controls">
                                    <input type="text" class="span3 m-wrap" id="teaName" name="teaName" value="${sessionScope.edit_teacher.teaName}" />
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">电子邮箱</label>
                                <div class="controls">
                                    <input type="email" class="span3 m-wrap" id="teaEmail" name="teaEmail" value="${sessionScope.edit_teacher.teaEmail}" required />
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码</label>
                                <div class="controls">
                                    <input type="password" class="span3 m-wrap" id="teaPwd" name="teaPwd" value="${sessionScope.edit_teacher.teaPwd}" />
                                </div>
                            </div>
