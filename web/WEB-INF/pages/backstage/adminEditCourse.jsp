            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="editCourse.action" class="form-horizontal" method="post" enctype="multipart/form-data">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span3 m-wrap" id="couName" name="couName" value="${sessionScope.courseById.couName}" />
                                </div>
                            </div>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <textarea class="span5 m-wrap" rows="8" id="couInfo" name="couInfo">${sessionScope.courseById.couInfo}</textarea>
                                </div>
                            </div>
