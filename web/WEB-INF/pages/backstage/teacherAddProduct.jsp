            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="addProduct.action" class="form-horizontal" method="post" enctype="multipart/form-data">
                            <div class="control-group">
                                <label class="control-label">作品名称</label>
                                <div class="controls">
                                    <input type="text" class="span3 m-wrap" id="proName" name="proName" required/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">作品类型</label>
                                <div class="controls">
                                    <select class="span3 m-wrap" data-placeholder="Choose a Category" tabindex="1" id="proType" name="proType" required>
                            ...
                            <div class="control-group">
                                <label class="control-label">作品序号</label>
                                <div class="controls">
                                    <input type="text" class="span3 m-wrap" id="proNo" name="proNo" required onkeyup="value=value.replace(/[^\d{1,}\.\d{1,}|\d{1,}]/g,'')" />
                                </div>
                            </div>
                            <div class="control-group">
                                        ...
                                        <div class="input-append">
                                            <div class="uneditable-input">
                                                ...
                                                <span class="fileupload-preview"></span>
													...
													<input type="file" style="height:20px" id="upload" name="upload" required/>
													</span>
