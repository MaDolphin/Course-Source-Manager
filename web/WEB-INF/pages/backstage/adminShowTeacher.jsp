                ...
                <div class="span12">
                    ...
                    <div class="portlet-body form">
                        ...
                        <form action="editTeacher.action" class="form-horizontal" method="post"
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span3 m-wrap" id="teaId" name="teaId"
                                           value="${sessionScope.show_teacher.teaId}" readonly/>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span3 m-wrap" id="teaName" name="teaName"
                                           value="${sessionScope.show_teacher.teaName}" readonly/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">电子邮箱</label>
                                <div class="controls">
                                    <input type="email" class="span3 m-wrap" id="teaEmail" name="teaEmail"
                                           value="${sessionScope.show_teacher.teaEmail}" readonly/>
                                </div>
                            </div>
                        </form>
                        <!-- END FORM-->
                    ...
                    <div class="portlet box purple">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-user"></i>教师授课列表</div>
                        </div>
                        <div class="portlet-body">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_adminshowteacher">
                                ...
                                <tbody>
                                <c:forEach items="${sessionScope.show_teacher_list}" var="cou">
                                    <tr class="odd gradeX">
